...
%  index = pkd_cir(abs(zt_han), noi, side, peak_width);
 ...
 stoa_amp = [stoa_amp 20*log10(abs(zt_han(index(2))))-bias];
...
fprintf(fid2, '%f %f %f %f %f %0.5g %0.5g', Mean_FP,Var_FP,Mean_error,Mean_RSS,Var_RSS,Var_error,Mean_delayofFirsttwopath);
fprintf(fid2, '\n');
fclose(fid2);
